...
BOOLEAN DoesTempFileExistsForMap(UINT32 uiType, u8 sMapX, u8 sMapY, i8 bMapZ);
...
UINT32 UpdateLoadedSectorsItemInventory(u8 sMapX, u8 sMapY, i8 bMapZ, UINT32 uiNumberOfItems);
