...
BOOLEAN FullStructAlone(INT16 sGridNo, uint8_t ubRadius);
...
void DoGenericHit(struct SOLDIERTYPE *pSoldier, uint8_t ubSpecial, INT16 bDirection) {
...
#if 0
uint8_t  atan8( INT16 x1, INT16 y1, INT16 x2, INT16 y2 )
{
