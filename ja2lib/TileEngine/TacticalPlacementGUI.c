...
void RenderTacticalPlacementGUI() {
  ...
  if (gfTacticalPlacementGUIDirty) {
    BltVideoObjectFromIndex(vsFB, giOverheadPanelImage, 0, 0, 320, VO_BLT_SRCTRANSPARENCY);
    ...
    for (i = 0; i < giPlacements; i++) {  // Render the mercs
      ...
      BltVideoObjectFromIndex(vsFB, giMercPanelImage, 0, xp, yp, VO_BLT_SRCTRANSPARENCY);
