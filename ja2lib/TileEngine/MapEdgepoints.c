...
void SaveMapEdgepoints(FileID fp) {
  ...
  if (gus1stNorthEdgepointArraySize)
    File_Write(fp, gps1stNorthEdgepointArray, gus1stNorthEdgepointArraySize * sizeof(INT16), NULL);
  ...
  if (gus1stEastEdgepointArraySize)
    File_Write(fp, gps1stEastEdgepointArray, gus1stEastEdgepointArraySize * sizeof(INT16), NULL);
  ...
  if (gus1stSouthEdgepointArraySize)
    File_Write(fp, gps1stSouthEdgepointArray, gus1stSouthEdgepointArraySize * sizeof(INT16), NULL);
  ...
  if (gus1stWestEdgepointArraySize)
    File_Write(fp, gps1stWestEdgepointArray, gus1stWestEdgepointArraySize * sizeof(INT16), NULL);
  ...
  if (gus2ndNorthEdgepointArraySize)
    File_Write(fp, gps2ndNorthEdgepointArray, gus2ndNorthEdgepointArraySize * sizeof(INT16), NULL);
  ...
  if (gus2ndEastEdgepointArraySize)
    File_Write(fp, gps2ndEastEdgepointArray, gus2ndEastEdgepointArraySize * sizeof(INT16), NULL);
  ...
  if (gus2ndSouthEdgepointArraySize)
    File_Write(fp, gps2ndSouthEdgepointArray, gus2ndSouthEdgepointArraySize * sizeof(INT16), NULL);
  ...
  if (gus2ndWestEdgepointArraySize)
    File_Write(fp, gps2ndWestEdgepointArray, gus2ndWestEdgepointArraySize * sizeof(INT16), NULL);
}
