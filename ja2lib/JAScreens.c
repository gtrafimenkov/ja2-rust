...
UINT32 SexScreenHandle(void) {
  ...
  if (bCurFrame < 24) {
    BltVideoObjectFromIndex(vsFB, guiSMILY, 0, sX, sY, VO_BLT_SRCTRANSPARENCY);
  } else {
    BltVideoObjectFromIndex(vsFB, guiSMILY, (INT8)(bCurFrame % 8), sX, sY, VO_BLT_SRCTRANSPARENCY);
  }
