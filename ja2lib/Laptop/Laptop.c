...
void WWWRegionMvtCallback(struct MOUSE_REGION *pRegion, INT32 iReason) {
  ...
  if (iReason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
    ...
    BltVideoObject2(vsFB, hLapTopIconHandle, (UINT16)iFrame, LAPTOP_ICONS_X, LAPTOP_ICONS_WWW_Y,
...
void EmailRegionMvtCallback(struct MOUSE_REGION *pRegion, INT32 iReason) {
  ...
  if (iReason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
    ...
    BltVideoObject2(vsFB, hLapTopIconHandle, (UINT16)iFrame, LAPTOP_ICONS_X, LAPTOP_ICONS_MAIL_Y,
                    VO_BLT_SRCTRANSPARENCY);
    if (fUnReadMailFlag) {
...
void FinancialRegionMvtCallback(struct MOUSE_REGION *pRegion, INT32 iReason) {
  ...
  if (iReason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
    ...
    BltVideoObject2(vsFB, hLapTopIconHandle, (UINT16)iFrame, LAPTOP_ICONS_X - 4,
...
void HistoryRegionMvtCallback(struct MOUSE_REGION *pRegion, INT32 iReason) {
  ...
  if (iReason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
    ...
    BltVideoObject2(vsFB, hLapTopIconHandle, (UINT16)iFrame, LAPTOP_ICONS_X, LAPTOP_ICONS_HISTORY_Y,
                    VO_BLT_SRCTRANSPARENCY);
    DrawLapTopText();
    HighLightRegion(giCurrentRegion);
    InvalidateRegion(0, 0, 640, 480);
...
void FilesRegionMvtCallback(struct MOUSE_REGION *pRegion, INT32 iReason) {
  ...
  if (iReason & MSYS_CALLBACK_REASON_LOST_MOUSE) {
    ...
    BltVideoObject2(vsFB, hLapTopIconHandle, (UINT16)iFrame, LAPTOP_ICONS_X,
...
BOOLEAN DisplayLoadPending(void) {
  ...
  while (iTempTime > 0) {
    ...
    BltVideoObject2(vsFB, hLapTopIconHandle, 0, LAPTOP_BAR_X + (UNIT_WIDTH * iCounter),
                    LAPTOP_BAR_Y, VO_BLT_SRCTRANSPARENCY);
    iTempTime -= iUnitTime;
    iCounter++;
...
BOOLEAN InitTitleBarMaximizeGraphics(UINT32 uiBackgroundGraphic, STR16 pTitle, UINT32 uiIconGraphic,
  ...
  BltVideoObject(guiTitleBarSurface, hImageHandle, 0, 0, 0, VO_BLT_SRCTRANSPARENCY);
