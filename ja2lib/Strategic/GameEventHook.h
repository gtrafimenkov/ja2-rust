...
BOOLEAN AddStrategicEventUsingSeconds(UINT8 ubCallbackID, uint32_t uiSecondStamp, uint32_t uiParam);
...
BOOLEAN AddPeriodStrategicEvent(UINT8 ubCallbackID, uint32_t uiOnceEveryXMinutes, uint32_t uiParam);
