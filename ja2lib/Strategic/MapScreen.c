...
static BOOLEAN GetMapXY(int16_t sX, int16_t sY, u8 *psMapWorldX, u8 *psMapWorldY);
...
static void RenderMapHighlight(u8 sMapX, u8 sMapY, uint16_t usLineColor, BOOLEAN fStationary);
