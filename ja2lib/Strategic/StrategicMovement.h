...
void SetGroupSectorValue(u8 sSectorX, u8 sSectorY, i8 sSectorZ, uint8_t ubGroupID);
...
void PlaceGroupInSector(uint8_t ubGroupID, u8 sPrevX, u8 sPrevY, u8 sNextX, u8 sNextY, int8_t bZ,
