...
BOOLEAN DrawTextToScreen(STR16 pStr, UINT16 LocX, UINT16 LocY, UINT16 usWidth, uint32_t ulFont,
                         UINT8 ubColor, UINT8 ubBackGroundColor, BOOLEAN fDirty, uint32_t FLAGS);
